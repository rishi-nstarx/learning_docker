# before running the start-db.sh you should create network and volumes manually so then only scripts would be able to find them.
# or else just run 'setup.sh' as it also does the same thing.
